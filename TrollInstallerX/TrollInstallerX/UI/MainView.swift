                ...
                ZStack {
                    ...
                    VStack {
                        VStack {
                            ...
                            Text(device.supportsCoreTrustInstall ? "iOS 26.6.1 (23G82), iOS 27.0 RC (24A-24Z)" : "iOS 14.0 - 16.6.1")
                        ...
                        ZStack {
                            ...
                            if device.supportsCoreTrustInstall && !isInstalling {
                                Button(action: {
                                    UIImpactFeedbackGenerator().impactOccurred()
                                    refreshAppRegistrationsCoreTrust()
                                }, label: {
            ...
            .onChange(of: isInstalling) { _ in
                Task {
                    if device.isSupported {
                        if device.supportsCoreTrustInstall {
                            installedSuccessfully = await doCoreTrustInstall(device)
